...
function ProjectCard({ logo, logoAlt, content }: ProjectsCardProps) {
    ...
    return (
        <>
            <div
                // md:hover:scale-100 sm:hover:scale-100
                className="cursor-pointer sm:justify-center sm:place-self-center h-[6.5rem] rounded-xl transition-all flex justify-center items-center minlg:hover:scale-105 md:h-[5.5rem] sm:w-2/3 sm:h-[5.2rem] xs:w-3/4"
                itemProp="name"
                role="button"
