...
function About() {
    const { t } = useTranslation()
        return (
            <section className='flex flex-row justify-around min-h-fit mx-24 mt-9 mb-20 py-3 px-7 lg:min-h-80 lg:mx-[7%] lg:py-1 lg:px-3 md:flex-wrap md:mb-8' itemScope itemType='https://schema.org/Person'>
