...
function Skills() {
    ...
    const SkillsCard = ({icon, text, iconAlt}: SkillsCardProps) => (
        <div className='flex flex-col items-center justify-center text-105 sm:text-90 my-5 lg:my-7 lg:py-0.5 sm:my-5 xs:my-3' itemProp="skill">
            <img className='mb-[0.35rem] text-color13 max-h-[36px] max-w-[47px]' src={icon} alt={iconAlt} style={text === 'Tailwind' ? { marginBottom: '0.7rem' } : {}} />
    ...
    return (
        <section id="skills" className='flex flex-col justify-around mx-24 my-7 lg:mx-[5%] md:mx-0 xs:mb-0 lg:pt-4' itemScope itemType="https://schema.org/Person">
            <h2 className='flex flex-row text-150 my-8 pb-8 items-center w-full text-color13 md:px-[8%] sm:mb-4 sm:text-145 xs:text-140'>
            ...
            <div className='skills-container flex flex-row lg:flex-wrap pb-3'>
                <motion.section className='flex flex-col w-1/2 mr-4 xl:w-3/5 xl:mx-4 lg:w-full lg:items-center lg:mt-7' animate={ hasAnimated  ? { x: 0, opacity: 1 } : { x: -170, opacity: 0.8 }} transition={{ duration: 0.65, ease: 'easeOut' }} >
                    ...
                    <div className='flex justify-center items-center pl-5 pr-6 ml-14 w-4/5 xl:pl-10 xl:pr-10 lg:w-7/12 lg:pl-6 lg:pr-14 lg:ml-16 lg:mr-2 md:mr-6 md:pr-11 md:pl-7 sm:pl-2 sm:pr-7 xs:ml-[3.25rem] xs:mr-1 xs:pl-1 xs:pr-8'>
                        ...
                        <span className='inline-block w-1/2 h-0.5 bg-color13 lg:bg-color13/20 ml-6 mr-4 xl:pl-2 lg:mr-4 lg:ml-6 lg:px-8 rounded-full md:pl-9 md:ml-5 md:pr-10 md:mr-3 sm:w-3/4 '></span>
                    ...
                    <div className='flex justify-center items-center lg:mx-12 lg:w-11/12 lg:pl-10 lg:pr-5 sm:pl-6 sm:pr-1 xs:pr-0 xs:pl-4'>
                        ...
                        <span className='inline-block w-3/5 h-0.5 bg-color13 lg:bg-color13/20 ml-7 mr-6 rounded-full'></span>
                    ...
                    <div className='flex justify-center items-center pl-3 pr-5 ml-12 w-3/4 xl:pl-7 xl:pr-7 lg:w-7/12 lg:pl-5 lg:pr-20 lg:ml-18 lg:mr-2 md:mr-3 md:pr-16 sm:pl-1 sm:pr-12 xs:ml-9 xs:mr-0 xs:pl-0 xs:pr-11'>
                        ...
                        <span className='inline-block w-1/2 h-0.5 bg-color13 lg:bg-color13/20 ml-4 mr-7 pr-10 lg:mr-6 lg:ml-3 lg:pr-12 lg:pl-7 rounded-full md:pr-14 md:pl-6 md:mr-6 md:ml-4 sm:w-3/4'></span>
                ...
                <section className='flex flex-row w-1/2 place-content-evenly pl-1 pr-2 py-7 text-color13 xl:w-2/5 xl:pr-0 lg:mx-20 lg:w-full lg:flex-wrap lg:pb-0 sm:mx-4 xs:mx-0'>
                    <div className='w-1/12 flex flex-row mr-11 xl:mr-8 lg:flex-col lg:w-full lg:mx-20 lg:pb-8 lg:pt-5 md:pb-6 sm:mx-20 sm:pb-5 xs:mx-24'>
                        <span className='inline-block w-1 h-full bg-gradient-to-b from-color13/40 to-color13/70 rounded-full mr-2 lg:mr-0 lg:mb-1 lg:pb-0.5 lg:h-0.5 lg:w-full lg:bg-gradient-to-l'></span>
                        <span className='inline-block w-1 h-full bg-gradient-to-t from-color13/40 to-color13/70 rounded-full ml-0.5 lg:ml-0 lg:h-0.5 lg:w-full lg:bg-gradient-to-r'></span>
                    </div>
