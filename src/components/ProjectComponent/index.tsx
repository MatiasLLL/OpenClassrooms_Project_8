...
function ProjectComponent({logo, logoAlt, content}: ProjectsCardProps) {
	...
	return (
		<>
			<div className='cursor-pointer rounded-full h-[6.5rem] w-[70%] bg-color13 flex justify-center items-center shadow-inner shadow-color17 text-link sm:text-active hover:text-color13/60' onClick={() => handleShowModal(content)}>
