...
function NavBar() {
    ...
    // rounded-xl shadow-sm shadow-color17
    ...
    return (
        <nav className='group/menu text-color17 fixed text-skills top-0 right-0 py-3 sm:px-4 h-screen w-20 md:hover:w-20 lg:hover:w-20 flex flex-col bg-color10 shadow-sm shadow-color13 hover:w-52 hover:duration-100 text-center justify-between sm:bottom-0 sm:flex-row sm:py-0 sm:top-auto sm:w-screen sm:h-20 sm:hover:w-screen sm:justify-around'>
