...
function NavBar() {
    ...
    const navItems = useMemo(() => [
        { icon: <FaAddressCard size="27" />, text: t('categories.about'), anchor: '#about' },
        { icon: <GiSkills size="27" />, text: t('categories.skills'), anchor: '#skills' },
        { icon: <IoCodeSlash size="27" />, text: t('categories.projects'), anchor: '#projects' },
    ], [t]);
    const navItemsLast = useMemo(() => [
        { icon: <IoShareSocial size="27" />, text: t('categories.contact'),  anchor: '#contact'}
    ], [t]);
