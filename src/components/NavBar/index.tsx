...
function NavBar() {
    ...
    const NavCat = ({icon, text, anchor}: NavCatProps) => (
        <li className='hover:text-color13/50 flex justify-center items-center py-1 text-center group-hover/menu:flex group-hover/menu:justify-start group-hover/menu:pl-5 group-hover/menu:sm:pl-0 group-hover/menu:sm:justify-center group-hover/menu:md:pl-0 group-hover/menu:lg:pl-0 group-hover/menu:md:justify-center group-hover/menu:lg:justify-center'>
            <a href={anchor} className={ active === anchor ? 'group/link active text-color13/40 flex flex-row transition-all static text-center sm:justify-center group-hover/menu:flex group-hover/menu:justify-start group-hover/menu:items-center group-hover/menu:sm:flex-row group-hover/menu:sm:justify-center' : 'group/link transition-all flex flex-row static text-center sm:justify-center group-hover/menu:flex group-hover/menu:justify-start group-hover/menu:items-center group-hover/menu:sm:flex-row group-hover/menu:sm:justify-center' }>
                <i className='group/icon rounded-full border border-color13/10 relative flex items-center justify-center h-12 w-12 mt-2 mb-2 mx-auto transition-all duration-100 ease-linear cursor-pointer xs:h-11 xs:w-11 group-hover/link:transition-all group-hover/link:duration-100 group-hover/link:ease-linear group-hover/link:bg-color17/10 group-[.active]/link:transition-all group-[.active]/link:duration-100 group-[.active]/link:ease-linear group-[.active]/link:bg-color17/10' style={anchor === '#contact' ? { paddingRight: '2px' } : {} }>{icon}</i>
    ...
    return (
        <nav className='group/menu z-50 bg-color17 text-color13/90 fixed text-skills top-0 right-0 py-3 h-screen w-20 flex flex-col shadow-sm shadow-[#35689f] hover:w-52 hover:duration-100 text-center justify-between lg:bottom-0 lg:flex-row lg:px-4 lg:py-0 lg:top-auto lg:w-screen lg:h-20 lg:hover:w-screen :justify-around'>
